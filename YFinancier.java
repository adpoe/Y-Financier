 ...
 *
 */
public class YFinancier  {
    String stockSymbol;
    String outputFileName;

    /**
     * No args constructor.
     * Sets the symbol to "SPY" - S&P 500 Index Fund
     * Sets output File to "finance.csv".
     * Unless otherwise specified, file will be downloaded to the directory from which this program is run
     */
    public YFinancier() {
        setSymbol("SPY");
        setOutputFileName("finance.csv");
    }
    ...
    /**
     * Copy constructor
     * @param yFinancierInstance - another instance of YFinancier to copy
     */
    public YFinancier(YFinancier yFinancierInstance) {
        setSymbol(yFinancierInstance.getStockSymbol());
        setOutputFileName(yFinancierInstance.getOutputFileName());
    }
    ...
    public String createURLString(String day, String month, String year){
        String returnURL = "http://real-chart.finance.yahoo.com/table.csv?s=" + stockSymbol +"&a=" +
    ...
    public void downloadFile() {
        ...
        while (fileUnavailable) {
            ...
            month = dates.get(1);
            year = dates.get(2);
            String financeURL = yFinancier.createURLString(day, month, year);
